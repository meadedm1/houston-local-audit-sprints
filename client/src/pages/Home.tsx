...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#f7f8f5] text-[#15231f]">
      ...
      {selectedLead && <LeadDrawer detail={detail} loading={detailQuery.isLoading} onClose={() => setSelectedLead(null)} onStatus={(status) => setDraftStatus.mutate({ leadId: selectedLead, status })} pending={setDraftStatus.isPending} />}
    </div>
  );
}
